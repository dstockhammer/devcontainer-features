...
# Dan's zsh config (zsh)

Sets up zsh as default shell with [Dan's zsh config](https://github.com/dstockhammer/zsh).
...
| zshHistory | The location of the .zsh_history file. Leave empty for default in Docker volume. | string | - |
